...
<body id="second">
    <div id="divmid">
        <h1 style="text-align: center;" id="textthird">Vos produits</h1>

        <?php
        $idu = $_SESSION["idu"];
        $stmt = $pdo->prepare("SELECT * FROM produit WHERE idu=?");
        $stmt->execute([$idu]);
        ...
        ?><a href="detailprod.php?idp=<?php echo "$idp" ?>" style="color: black;">
                <div id="prodfav" style="position: relative;">
                    ...
                    <a href="modifproduit.php?idp=<?php echo "$idp" ?>" style="margin-right: 1%; text-align: left; position: absolute; left: 92%; top: 40%;"><img src="image/modif.png" width="20"></a>
                    <a href="deleteprod.php?idp=<?php echo "$idp" ?>" style="margin-right: 1%; text-align: left; position: absolute; left: 95%; top: 40%;"><img src="image/delete.png" width="20"></a>
                    <hr>
                </div>
            </a>
        <?php
